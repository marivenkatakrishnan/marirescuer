...
USING ${datasource_format}
LOCATION ${dataLocation}'/call_center.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/catalog_page.csv'
;
...
USING ${datasource_format} 
LOCATION ${dataLocation}'/catalog_returns.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/catalog_sales.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/customer.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/customer_address.csv'
;

-- customer demographhics
...
USING ${datasource_format}
LOCATION ${dataLocation}'/customer_demographics.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/date_dim.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/household_demographics.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/income_band.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/inventory.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/item.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/promotion.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/reason.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/ship_mode.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/store.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/store_returns.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/store_sales.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/time_dim.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/warehouse.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/web_page.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/web_returns.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/web_sales.csv'
;
...
USING ${datasource_format}
LOCATION ${dataLocation}'/web_site.csv'
;
...
-- start query 81 in stream 0 using template query82.tpl and seed QUALIFICATION
select 'query81';
select '----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------';
  with customer_total_return as 
(
...
select '----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------';
-- end query 81 in stream 0 using template query82.tpl
...
select '----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------';
 ...
 from ( select count(*) amc
       ...
       where ws_sold_time_sk = time_dim.t_time_sk
         ...
         and web_page.wp_char_count between 5000 and 5200) at1 CROSS JOIN
      ( select count(*) pmc
       from web_sales, household_demographics , time_dim, web_page
       where ws_sold_time_sk = time_dim.t_time_sk
         and ws_ship_hdemo_sk = household_demographics.hd_demo_sk
